...
class HotelController extends AbstractController
{
     ...
     */
    public function new(Request $request, HotelRepository $hotelRepository,MailerInterface $mailer,FlashyNotifier $flashy): Response
    {
        $hotel = new Hotel();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $email->sendEmail( $mailer,'testapimail63@gmail.com','mahdi.homrani@esprit.tn','testing email','Hotel Crée avec success');
            $this->addFlash(
                'info' ,' ');
