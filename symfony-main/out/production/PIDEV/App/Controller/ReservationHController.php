...
class ReservationHController extends AbstractController
{
     ...
     */
    public function new(Request $request, ReservationHRepository $reservationHRepository,MailerInterface $mailer,FlashyNotifier $flashy): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $email->sendEmail( $mailer,'testapimail63@gmail.com','benromdhane.zeineb@esprit.tn','testing email','Reservation Créer avec success');
            $this->addFlash(
                'info' ,' Reservation ajoute !');
