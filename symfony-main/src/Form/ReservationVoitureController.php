...
{
    /**
     * @Route("/", name="reservation_voiture_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="reservation_voiture_new", methods={"GET", "POST"})
     */
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('reservation_voiture_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{idRv}", name="reservation_voiture_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idRv}/edit", name="reservation_voiture_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idRv}", name="reservation_voiture_delete", methods={"POST"})
     */
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$reservationVoiture->getIdRv(), $request->request->get('_token'))) {
